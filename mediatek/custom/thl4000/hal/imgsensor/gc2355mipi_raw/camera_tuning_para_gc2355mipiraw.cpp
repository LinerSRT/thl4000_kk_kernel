...
{{
    ...
    ISPCcmPoly22:{
        ...
        22352,    // i4B_STD
        {  // i4P00[9]
            5132500, -2230000, -342500, -917500, 3607500, -125000, -607500, -2315000, 5482500
        },
        {  // i4P10[9]
            785677, -976129, 203555, -32226, -5, 38218, 345868, 685638, -1045735
        },
        {  // i4P01[9]
            552448, -586423, 42420, -191927, -110727, 308930, -112593, -244370, 352625
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
...
{
    #include "camera_tsf_para_gc2355mipiraw.h"
    #include "camera_tsf_data_gc2355mipiraw.h"
};
