...
#ifdef GC2355_DEBUG
	#define GC2355DB(fmt, arg...) xlog_printk(ANDROID_LOG_INFO, "[GC2355Raw] ",  fmt, ##arg)
#else
...
#define GC2355_ORIENTATION IMAGE_HV_MIRROR //IMAGE_NORMAL//IMAGE_NORMAL
...
#define ANALOG_GAIN_7 470  // 7.15x
	...
	iReg = iGain;
	//digital gain
	//GC2355_write_cmos_sensor(0xb1, iReg>>6);
	//GC2355_write_cmos_sensor(0xb2, (iReg<<2)&0xfc);
...
*/
    ...
    GC2355_write_cmos_sensor(0x2b, 0x80);
...
UINT32 GC2355GetSensorID(UINT32 *sensorID)
{
	...
	printk("[lifeng]GC2355GetSensorID enter :\n ");
    // check if sensor ID correct
    *sensorID =((GC2355_read_cmos_sensor(0xf0) << 8) | GC2355_read_cmos_sensor(0xf1)); 
	GC2355DB("GC2355MIPIGetSensorID:%x \n",*sensorID);
	printk("[lifeng]GC2355MIPIGetSensorID:%x \n",*sensorID);
