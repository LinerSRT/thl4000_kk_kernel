...
#define GC5004MIPI_TEST_PATTERN_CHECKSUM 0x54ddf19b 
...
static void GC5004MIPI_Init_Settings(void)
{
	...
	GC5004MIPI_write_cmos_sensor(0x17, 0x16); //01//14//[0]mirror [1]flip
	...
	GC5004MIPI_write_cmos_sensor(0x94, 0x04); //04/crop win x
	...
	//////////////////////   BLK   //////////////////////
	/////////////////////////////////////////////////////
	GC5004MIPI_write_cmos_sensor(0x40, 0x22); // 72 20141106
...
static void GC5004MIPIVideoSettings(void)
{
	...
	GC5004MIPI_write_cmos_sensor(0x4e, 0x00); //blk 20140722
	GC5004MIPI_write_cmos_sensor(0x4f, 0x3c);  
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->AEISPGainDelayFrame = 2; //4 
...
{
    SENSORDB("[GC5004SetTestPatternMode]test pattern bEnable:=%d\n",bEnable);
    if(bEnable)
    {
	GC5004MIPI_write_cmos_sensor(0xfe, 0x00);
	GC5004MIPI_write_cmos_sensor(0x03, 0x07); 
	GC5004MIPI_write_cmos_sensor(0x04, 0x38); 
	GC5004MIPI_write_cmos_sensor(0x18, 0x06);
	GC5004MIPI_write_cmos_sensor(0x40, 0x70);
	GC5004MIPI_write_cmos_sensor(0x60, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x61, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x62, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x63, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x64, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x65, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x66, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x67, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x68, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x69, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x6a, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x6b, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x6c, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x6d, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x6e, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x6f, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xe0, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xe1, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xe2, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xe3, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xe4, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xe5, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xe6, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xe7, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xe8, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xe9, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xea, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xeb, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xec, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xed, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xee, 0x00); 
	GC5004MIPI_write_cmos_sensor(0xef, 0x00);
	...
	GC5004MIPI_write_cmos_sensor(0xb5, 0x40);
	GC5004MIPI_write_cmos_sensor(0xb6, 0x00);
	GC5004MIPI_write_cmos_sensor(0x8c, 0x12);
    }
    else
    {
	GC5004MIPI_write_cmos_sensor(0xfe, 0x00); 
	GC5004MIPI_write_cmos_sensor(0x8c, 0x02);
    }
    return ERROR_NONE;
}
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:	
		       *pFeatureReturnPara32=GC5004MIPI_TEST_PATTERN_CHECKSUM;
		       *pFeatureParaLen=4;
		       break;
		default:
			break;
