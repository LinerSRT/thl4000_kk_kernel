...
static void GC2355MIPI_Sensor_Init(void)
{
	...
	GC2355MIPI_write_cmos_sensor(0x19,0x0b);
    	GC2355MIPI_write_cmos_sensor(0x11, 0x48);
    	GC2355MIPI_write_cmos_sensor(0x48, 0x12);
    	GC2355MIPI_write_cmos_sensor(0x1d, 0x10);
    	GC2355MIPI_write_cmos_sensor(0x1e, 0x120);
	...
	GC2355MIPI_write_cmos_sensor(0x4b,0x00);	
    	GC2355MIPI_write_cmos_sensor(0x4c, 0x3c);
    	GC2355MIPI_write_cmos_sensor(0x4d, 0x00);
