...
static struct alsps_hw cust_alsps_hw = {
    ...
    //.ps_threshold_high = 1000, //Датчик работает,
    //.ps_threshold_low = 400,  //но не корректно. Данные в положении "1" нестабильны
    //.ps_threshold = 0,
};
 ...
 */
static int ps_trigger_high = 0;				//yaoyaoqin: trigger up threshold
static int ps_trigger_low = 30;				//yaoyaoqin: trigger low threshold
